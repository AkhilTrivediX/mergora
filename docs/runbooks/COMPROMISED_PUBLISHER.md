...
1. Freeze npm publication environments and website deployment if artifact integrity is uncertain.
...
Review repository settings, branch/tag rules, workflow and Action changes, environments, OIDC claims,
package owners, dist tags, package contents, provenance, GitHub Releases, website artifacts,
registry mirrors, issues/advisories, and recently rotated secrets.
...
4. Restore known-good dist tags and website/registry artifacts where safe.
