...
const SOURCE_BLUEPRINTS: readonly SourceBlueprint[] = [
  ...
  },
  {
    ...
    declaredImports: ["./data-grid.css", "./data-grid.js", "@tanstack/react-table", "react"],
    itemDependencies: [],
    outputRole: "system",
    runtimeFiles: [
    ...
    metadataPath: "registry/source/systems/data-grid/component.json",
    contractPath: "registry/source/systems/data-grid/contract.draft.json",
    storyPath: null,
    apiPath: null,
