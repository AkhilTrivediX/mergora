...
Promotion requires generated artifacts, package/source parity, native form and reset evidence, localized accessible value text, horizontal/vertical/RTL geometry, keyboard and drag cancellation coverage, narrow and forced-color review, and current manual assistive-technology sessions.
