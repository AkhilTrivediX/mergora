...
Promotion requires generated artifacts, package/source parity, locale and currency-minor-unit matrices, major-unit serialization and reset evidence, negative and accounting cases, IME and caret review, mobile and RTL geometry, forced colors, and current manual assistive-technology sessions.
